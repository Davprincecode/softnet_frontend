...
const ActiveProduct : React.FC<HeroInterface> = ({ heroFunction, editId, setEditId }) => {
        ...
        useEffect(() => {
          ...
          const getData = async (pageNumber : number) => {
              setLoading(true);
                  ...
                  try {
                      const response = await fetch(`${baseUrl}/active-admin-product?page=${pageNumber}`, requestOptions);
                      if (!response.ok) {
