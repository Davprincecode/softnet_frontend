...
const EditConsulting : React.FC<HeroInterface> = ({ heroFunction, editId, setEditId }) => {     
      ...
      useEffect(() => {
       ...
       const getBlog = async () => {
          ...
          try {
            const response = await fetch(`${baseUrl}/consulting/${editId}`, requestOptions);
