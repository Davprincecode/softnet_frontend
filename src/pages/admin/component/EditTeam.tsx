...
const EditTeam : React.FC<HeroInterface> = ({ heroFunction, editId, setEditId }) => {     
     ...
     const [staffName, setStaffName] = useState<string>('');
         ...
         const [staffImg, setStaffImg]= useState<File | string | null>(null);
      ...
      useEffect(() => {
       ...
       const getBlog = async () => {
          ...
          try {
            const response = await fetch(`${baseUrl}/team/${editId}`, requestOptions);
             if (!response.ok) {
              ...
              const result = await response.json(); 
                ...
                setStaffPosition(result.data.staffPosition); 
                setStaffProfile(result.data.staffProfile);
                setStaffQuanlification(result.data.staffQuanlification);
                setStaffImg(result.data.staffImg);
          ...
          <div className="wrap-blog ">
                    ...
                    {/* <div className="admin-prd-form"> */}
                              ...
                              <div className="previewImage">
                                ...
                                <img
                                src={
                                    typeof staffImg === "string" 
                                    ? staffImg
                                    : URL.createObjectURL(staffImg)
                                }
                                alt="Preview"
