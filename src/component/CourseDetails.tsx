...
const CourseDetails : React.FC<authComponentInterface> = ({authAction, setAuthAction, popOrder}) =>{
      ...
      {  popOrder.map((item, index) => (
         ...
         <div className="customer-container-wrapper">
            ...
            <div className="consultant-details">
                        ...
                        <div className="time flex-center  gap-10"><h1>course id : </h1>{item.courseId}</div>
                        <div className="time flex-center  gap-10"><h1>course name : </h1>{item.courseName}</div>
                        <div className="time flex-center  gap-10"><h1>price : </h1>{Number(item.total).toLocaleString()}</div>
