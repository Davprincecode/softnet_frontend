...
const EditCategory : React.FC<authComponentInterface> = ({catPop,  setCatPop, catId, setCategory}) =>{
  ...
  useEffect(() => {
     ...
     const getCategory = async () => {
        ...
        try {
            const response = await fetch(`${baseUrl}/product-category/${catId}`, requestOptions);
